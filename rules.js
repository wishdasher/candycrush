...
class Rules {
	...
	/*
	*
	* Clears the current board and prepares a new game with no groups of
	* three adjacent same-color candies. Any time there is a group of adjacent
	* same-color candies, re-rolls them.
	...
	*/
	getRandomValidMove() {
		...
		var searchArray = validMovesThreeCrush.length ? validMovesThreeCrush : validMovesMoreThanThreeCrush;
		...
		for (var j = 0; j < board.boardSize; j++) {
			for (var h, k = 0; k < board.boardSize; k = h) {
				...
				for (; h < board.boardSize; h++) {
					...
					if (!lastCandy || lastCandy.color != firstCandy.color) {
						break;
					}
